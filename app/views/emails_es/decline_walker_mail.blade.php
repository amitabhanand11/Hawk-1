...
<html>
    <head>
        ...
        <title>Disminución controlador</title>
            ...
            <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
                        <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="{{ web_url() }}" style="color:#ffffff; outline:none; text-decoration:none;">Declinar como un controlador de <?php /*echo "App Name";*/ echo ucwords(Config::get('app.website_title')); ?></a></span>
                    </td>
                </tr>
                <!-- <tr>
                            ...
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">
                                       hola {{ $mail_body['walker_name'] }}, Ponte en contacto con nosotros para más detalles {{ $mail_body['admin_eamil'] }}
                                    </div>
                                    <br>
