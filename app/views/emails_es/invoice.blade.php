<html>
    ...
    <body style="margin: 0px; padding: 0px; border: 0px;font-family: sans-serif;">
        ...
        <div style="margin: 0px auto;width: 90%; padding: 15px;background-color: #ff9d3d;color: #FFFFFF;">
            <!-- logo -->            
            <div>
                <div style="float: left;"><img alt="logo" src="<?php echo asset_url(); ?><?php echo $logo; ?>" style="height: 75px;padding: 0px 0px 12px 0px;"><img alt="logo" src="{{ asset_url() }}/image/e_receipt.png" style="width: 150px;padding: 0px 0px 12px 50px;"></div>
            ...
            <div style="background-color: #FFFFFF;">
                <div style="background-color: #f3f3f3;border-bottom: 2px solid #c3c3c3;color: #000000;">
                    ...
                    <p style="color: #999999;float: right;margin: 0px;font-size: 16px; font-weight: normal; padding: 18px 0.6em 0px 0px;">Gracias por haber elegido <?= Config::get('app.website_title') ?>,{{ $mail_body['walker']->first_name }} {{ $mail_body['walker']->last_name }}</p>
                    <div style="clear: both;"></div>
                </div>
                <div style="padding: 1.5em;color: #000000;">
                    <div style="background-color: #f3f3f3;border: 2px solid #c3c3c3;border-radius: 5px;width: 45%;float: left;">
                        ...
                        <div style="margin: 15px 0px;padding: 0px;text-align: center;font-size: 14px;">
                            <div style="float: left;width: 33.32%;">
                                <p style="color: #999999;margin: 0px;padding: 0px;text-transform: uppercase;font-size: 10px;">Escribe un nombre</p>
                            ...
                            <div style="float: left;width: 33.32%;">
                                <p style="color: #999999;margin: 0px;padding: 0px;text-transform: uppercase;font-size: 10px;">Hora de viajar</p>
                    ...
                    <div style="width: 50%;float: right;">
                        <div>
                            ...
                            <div style="width: 40%;float: left;text-transform: uppercase;text-align: center;font-size: 12px;">tarifa</div>
                            <div style="width: 30%;float: left;border-bottom: 1px solid #c3c3c3;padding-top: 8px;"></div>
                            <h1 style="clear: both;"></h1>
                        </div>
                        <div style="color: #999999;font-size: 14px;">
                            <div>
                                <p style="margin: 0px;padding: 0px;float: left;">precio base</p>
                                <p style="margin: 0px;padding: 0px;float: right;color: #000000;">{{ $mail_body['base_price']}}</p>
                                <h1 style="clear: both;"></h1>
                            </div>
                            <div>
                                <p style="margin: 0px;padding: 0px;float: left;">precio distancia</p>
                                <p style="margin: 0px;padding: 0px;float: right;color: #000000;">{{ $mail_body['dist_cost'] }}</p>
                                <h1 style="clear: both;"></h1>
                            </div>
                            <div>
                                <p style="margin: 0px;padding: 0px;float: left;">precio tiempo</p>
                                <p style="margin: 0px;padding: 0px;float: right;color: #000000;">{{  $mail_body['time_cost'] }}</p>
                                <h1 style="clear: both;"></h1>
                            </div>
                            <div>
                                <p style="margin: 0px;padding: 0px;float: left;">bono de referencia</p>
                                <p style="margin: 0px;padding: 0px;float: right;color: #000000;">{{  $mail_body['ref_bonus'] }}</p>
                                <h1 style="clear: both;"></h1>
                            </div>
                            <div>
                                <p style="margin: 0px;padding: 0px;float: left;">bono promocional</p>
                            ...
                            <div style="color: #000000;font-weight: bold;">
                                <p style="margin: 0px;padding: 0px;float: left;">total parcial</p>
                            ...
                            <div>
                                <p style="margin: 0px;padding: 0px;float: left;text-transform: uppercase;font-size: 8px;">cargado</p>
                ...
                <div style="margin: 0px 0px 0px 1.5em;color: #000000;">
                    <div style="margin: 15px 0px;width: 50px;border-radius: 150px; width: 90%;">
                        ...
                        <?php } else { ?>
                            <img style="width: 50px; height: 50px;border-radius: 150px;border: 2px solid #999999;float: left;" height="50" width="50" alt="user image" src="{{ asset_url() }}/image/default_thumb.jpg">	
                        <?php } ?>
                            
                        <p style="float: left;margin: 5px 0 0 5px;padding: 0px;">
                            Usted montó con {{ $mail_body['walker']->first_name }} {{ $mail_body['walker']->last_name }}

                            <br/>
                           empresa de la red de transporte : <?php /* echo "App Name"; */echo ucwords(Config::get('app.website_title')); ?>.
                        </p>
                        <h1 style="clear: both;"></h1>
                    </div>
                </div>
                <div style="padding: 15px 0px 0px 0px;color: #ffffff;background-color: #ff9d3d">
                    <div style="margin: 15px 25px 15px 0;width: 50px;width: 48%;float: left; border-right: 1px solid rgba(255,255,255,.2);">
                        ...
                        <p style="float: right;margin: 5px 0 0 5px;padding: 0px;width: 81%;">
                            <span style="color: #000000;font-size: 12px;font-weight: bold;"><?= Config::get('app.website_title') ?> Apoyo</span>
                            <br/>
                            <span style="font-size: 12px;"><a href="{{ web_url() }}" style="color: #FFFFFF;">Contáctenos</a> con preguntas sobre su viaje.
                                <br/>
                                Dejar algo ? <a href="{{ web_url() }}" style="color: #FFFFFF;">Rastrearlo</a></span>
                        </p>
                        <h1 style="clear: both;"></h1>
                    </div>
                    ...
                    <h1 style="clear: both;"></h1>
                    <p style="text-align: center; font-size: 12px;margin-top: 30px;"> Para cualquier pregunta  {{ $mail_body['contact_us_email'] }}</p>
                </div>
