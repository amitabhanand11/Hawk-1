                        ...
                        <table width="100%" align="right" class="resp-full-table" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    <div style="padding: 10px;font-size:22px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;color: #ff9d3d;text-align:center;">Gracias por registrarte! Estamos muy contentos de que te unas a nosotros y empezar a montar.
                                    </div>

                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">Simplemente solicite una camioneta , y en cuestión de minutos un coche habrá acera y listo para llevarte a donde tiene que ir.
                                    </div>

                                    <div style="padding: 10px;font-size:20px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #ff9d3d;color:#fff;text-align:center;">3 pasos para Ride
                                    </div>
                                    <br>
                                    <div style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;">1. Pedir un coche 
                                    </div>
                                    <div style="padding: 0px 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;color:#545454;">Utilice la aplicación para iPhone o Android para solicitar un paseo 
                                    </div>

                                    <br>
                                    <div style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;">2. Su conductor viene a Usted 
                                    </div>
                                    <div style="padding: 0px 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;color:#545454;"> Siéntate y relájate. Te texto cuando su<?php /* echo "App Name"; */ echo ucwords(Config::get('app.website_title')) ?>  llega. 
                                    </div>

                                    <br>
                                    <div style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;">3. Hop Hop en y fuera
                                    </div>
                                    <div style="padding: 0px 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;color:#545454;">Después de llegar a su destino , que'll cargar su tarjeta de crédito en el archivo y el correo electrónico un recibo .
                                    </div>
                                    <br><br>

                                    <div style="text-align:center"><a href="{{ $mail_body['web_url'] }}" style="padding: 10px;font-size:18px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100;background-color: #ff9d3d;color:#fff;text-align:center;  text-decoration: none;">Ir al sitio </a></div>
                                    <br>
                                </td>
                            </tr>
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">
                                        Para cualquier pregunta {{ $mail_body['contact_us_email'] }}
                                    </div>
