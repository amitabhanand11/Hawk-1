...
<html>
    <head>
        ...
        <title>Aprobado controlador</title>
            ...
            <table width="660" class="resp-full-table" align="center" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td class="resp-full-td" valign="top" style="padding:20px; text-align:center;">
                        <span style="font-size:25px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#ffffff"><a href="{{ web_url() }}" style="color:#ffffff; outline:none; text-decoration:none;">Bienvenido {{ $mail_body['walker_name'] }} a <?php /* echo "App Name"; */ echo ucwords(Config::get('app.website_title')); ?></a></span>
                    </td>
                </tr>
                <!-- <tr>
                            ...
                            <tr>
                                <td width="100%" class="resp-full-td" valign="top" style="text-align : justify;">
                                    ...
                                    <div style="padding: 10px;font-size:12px; font-family:'Helvetica Neue', helvetica, arial, sans-serif; font-weight:100; color:#545454;text-align:center;">
                                        Usted es aprobado con éxito como un conductor.

                                        Usted está listo para servir
										<strong style="font-weight: bold;"><?php /* echo "App Name"; */echo ucwords(Config::get('app.website_title')); ?></strong> clientela.
                                    </div>
                                    <br>
