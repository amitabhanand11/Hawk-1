                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    $protype = ProviderType::where('id', $types->id)->first();

                                    if ($proviserv['base_price'] == 0) {
                                        echo sprintf2($protype->base_price, 2);
                                    } else {
                                        echo sprintf2($protype->base_price, 2);
                                    }
                                ...
                                <td>   
                                    <div class="col-sm-2">
                                        ...
                                        if ($proviserv['price_per_unit_distance'] == 0) {
                                            echo sprintf2($protype->price_per_unit_distance, 2);
                                        } else {
                                            echo sprintf2($protype->price_per_unit_distance, 2);
                                        }
                                        ?>" placeholder="Price per Distance(per km)" disabled>
                                        <br>
                                        </td>
                                        <td>
                                            <?php $counter++; ?>
                                            ...
                                            if ($proviserv['price_per_unit_time'] == 0) {
                                                echo sprintf2($protype->price_per_unit_time, 2);
                                            } else {
                                                echo sprintf2($protype->price_per_unit_time, 2);
                                            }
                                            ?>" placeholder="Price per unit time"  disabled><br>
