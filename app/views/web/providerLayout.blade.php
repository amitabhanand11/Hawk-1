                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div style="position:relative;float:left;left:10px;">
                            <i>User Name - </i><b id="owner-name"></b><br />
                            <i>Rating - </i><b id="owner-rating"></b> <b>/ 5</b><br/>
                            <i>Phone - </i><b id="owner-phone"></b><br/>
                            <i>User Address - </i><b id="owner-address"></b><br/>                        
                        </div>
                        <div>
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (res.length) {
                                ...
                                $('#owner-phone').html(res[3].phone);
                                $('#owner-address').html(res[3].my_address);
