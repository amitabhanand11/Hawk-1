...
<?php echo date("Y");?> - <?php echo Config::get('app.website_title'); ?>
                    <a href="#" class="go-top">
                                ...
                                if (parseInt(data) != parseInt(current_state)) {
                                    ...
                                    if (data == 1) {
                                        ...
                                        document.location = "{{route('userrequestTrip')}}";
                                           ...
                                           document.location = "{{route('/user/trips')}}";   
                                          <?php 
                                        ...
                                        if (data == 2) {
                                            ...
                                            title = "Your {{trans('customize.Trip')}} rejected by the {{trans('customize.Provider')}}";
                                            message = "Your {{trans('customize.Trip')}} has been rejected. Please try to request some other {{trans('customize.Provider')}} ";
                                        } 
