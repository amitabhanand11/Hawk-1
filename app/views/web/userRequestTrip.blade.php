    ...
    <div class="content-panel">
        <div class="row">
            ...
            <div class="col-md-11">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <input type="text" class="form-control" name="my_address" id="my-address" placeholder="Please enter Source address" style="margin-bottom:10px;width:65%;float:left;" onblur="codeAddress(1);" onchange="codeAddress(1);">
                        <button type="button" id="getCords" class="btn btn-success pull-right" onClick="codeAddress(1);">Find Location</button><br><br>
