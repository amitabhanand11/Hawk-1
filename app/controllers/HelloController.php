...
class HelloController extends \BaseController {
    ...
    public function arr() {
        ...
        /* } */
        $customer_msgs['1'] = "This Email ID is not Registered";
        ...
        $customer_msgs['26'] = 'You need to register using this social account first.';
        ...
        $customer_msgs['84'] = "Sorry, You can't create schedule more then two week faar from today.";
        ...
        $customer_msgs['102'] = 'Type is required for ETA calculation';
        $customer_msgs['103'] = 'ETA successfully sent.';
        $customer_msgs['104'] = 'This Social account is already registered with us.';
		
		
        /* print_r($customer_msgs); */
        $provider_msgs = array();
        $provider_msgs['1'] = "This Email ID is not Registered";
        ...
        $provider_msgs['11'] = 'Social unique id is required';
        ...
        $provider_msgs['22'] = 'Service ID does not matches with ' . Config::get('app.generic_keywords.Provider') . ' ID';
        ...
        $provider_msgs['41'] = 'Please Enter Destination Address';
        $provider_msgs['42'] = 'This Social account is already registered with us.';
        $provider_msgs['43'] = 'This email id already registered but it is soft deleted by admin.Please contact him first.';
		$provider_msgs['44'] = 'Social unique id is required';
